...
let PaymentsController = class PaymentsController {
    ...
    async webhook(body, xSignature, xRequestId, dataIdFromQuery) {
    ...
    async getStatus(externalReference) {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('data.id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, String, String]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "webhook", null);
__decorate([
    (0, common_1.Get)('status/:externalReference'),
    __param(0, (0, common_1.Param)('externalReference')),
    __metadata("design:type", Function),
